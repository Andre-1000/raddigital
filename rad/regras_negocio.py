...
def processar_sincronizacao(payload, usuario, fotos_intervencao=None, fotos_acao=None, pdfs=None):
    ...
    dados_rad = {
        ...
        'data_preenchimento': payload['data_preenchimento'],
        'data_atividade': payload.get('data_atividade'),
        'local_inicial': local_inicial,
        'local_final': local_final,
        'km_poste_inicial': payload.get('km_poste_inicial') or None,
        'km_poste_final': payload.get('km_poste_final') or None,
        'tipo_veiculo': payload.get('tipo_veiculo') or None,
        'operador': payload.get('operador') or None,
        ...
        'terceiros_num_motorista': payload.get('terceiros_num_motorista') or None,
        'terceiros_volume': payload.get('terceiros_volume') or None,
